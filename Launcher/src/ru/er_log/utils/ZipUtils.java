...
public class ZipUtils {
    ...
    public static void unzip(String file_path, String filename, boolean delete_after)
    {
        unzip(file_path, filename, file_path, delete_after);
    }
    
    public static void unzip(String file_path, String filename, String extract_to, boolean delete_after)
    {
        try
        {

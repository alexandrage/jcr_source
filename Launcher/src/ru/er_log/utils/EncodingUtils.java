...
public class EncodingUtils {
    ...
    public static String xencode(String text, String key)
    {
        String res = ""; int j = 0;
    ...
    public static String xdecode(String text, String key)
    {
        return xencode(text, key);
    }
    ...
    {
        String res = "";
        for (String split : text.split("-")) res += (char) Integer.parseInt(split);
        return res;
    }
}